...
public class BasicCameraController : SyncScript
{
    ...
    public override void Update()
    {
        ...
        // perform raycast and display hovered entity
    ...
    private void UpdateTransform()
    {
        ...
        Entity.Transform.Rotation *= Stride.Core.Mathematics.Quaternion.RotationAxis(right, pitch) * Stride.Core.Mathematics.Quaternion.RotationAxis(upVector, yaw);
    }
}
